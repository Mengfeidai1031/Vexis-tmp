<?php $__env->startSection('title', 'Chatbot IA - VEXIS'); ?>
<?php $__env->startSection('content'); ?>
<div class="vx-page-header"><h1 class="vx-page-title"><i class="bi bi-robot" style="color:var(--vx-primary);"></i> Asistente Virtual</h1><a href="<?php echo e(route('cliente.inicio')); ?>" class="vx-btn vx-btn-secondary"><i class="bi bi-arrow-left"></i> Volver</a></div>
...
async function sendMessage(text) {
    ...
    try {
        const res = await fetch('<?php echo e(route("cliente.chatbot.query")); ?>', {
            method: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mengf/Vexis_f/Vexis/resources/views/cliente/chatbot.blade.php ENDPATH**/ ?>
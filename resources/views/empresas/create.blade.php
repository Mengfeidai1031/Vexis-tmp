@extends('layouts.app')
@section('title', 'Crear Empresa - VEXIS')
@section('content')
<div class="vx-page-header">
    <h1 class="vx-page-title">Crear Nueva Empresa</h1>
        ...
        <form action="{{ route('empresas.store') }}" method="POST">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 16px;">
                ...
                <div class="vx-form-group">
                    ...
                    <input type="text" class="vx-input @error('abreviatura') is-invalid @enderror" id="abreviatura" name="abreviatura" value="{{ old('abreviatura') }}" maxlength="10" required style="max-width:150px;">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 16px;">
                <div class="vx-form-group">
                    ...
                    <input type="text" class="vx-input @error('cif') is-invalid @enderror" id="cif" name="cif" value="{{ old('cif') }}" maxlength="10" required placeholder="B12345678" style="font-family:var(--vx-font-mono);">
                ...
                <div class="vx-form-group">
                    ...
                    <input type="text" class="vx-input @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ old('telefono') }}" maxlength="12" required placeholder="928123456">
            ...
            <div class="vx-form-group">
                ...
                <input type="text" class="vx-input @error('codigo_postal') is-invalid @enderror" id="codigo_postal" name="codigo_postal" value="{{ old('codigo_postal') }}" maxlength="5" style="max-width:150px;">

@extends('layouts.app')
@section('title', 'Editar ' . $departamento->nombre . ' - VEXIS')
@section('content')
<div class="vx-page-header">
    <h1 class="vx-page-title">Editar: {{ $departamento->nombre }}</h1>
        ...
        <div class="vx-card-body">
            <form action="{{ route('departamentos.update', $departamento->id) }}" method="POST">
                ...
                <div class="vx-form-group">
                    ...
                    <input type="text" class="vx-input @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre', $departamento->nombre) }}" required>
                ...
                <div class="vx-form-group">
                    ...
                    <input type="text" class="vx-input @error('abreviatura') is-invalid @enderror" id="abreviatura" name="abreviatura" value="{{ old('abreviatura', $departamento->abreviatura) }}" maxlength="10" required>
